...
//    Search
    ...
    Route::get('/findUserName','SearchNameController@findUserName');
    Route::get('/findLabExpName','SearchNameController@findLabExpName');

    Route::resource('search-by-name', 'SearchNameController');
